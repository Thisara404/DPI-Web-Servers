class ApiEndpoints {
  ...
  static const String baseUrl = 'http://192.168.43.187:3000'; // API Gateway port
  ...
  static const String driverValidateToken = '$apiUrl/driver/auth/validate-token';
...
// Note: Ensure that the API Gateway is configured to route these endpoints correctly to the respective services (Driver, NDX, etc.)